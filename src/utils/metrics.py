...
class MetricsTracker:
    ...
    def record_processing_metrics(
        ...
        if total_processed > 0:
            self.processing.avg_processing_time = (
                self.processing.total_processing_time / total_processed
            )

    def record_excel_generation(
        self, num_listings: int, num_rows: int, duration_seconds: float
    ) -> None:
        """
    ...
    def record_cache_hit(self, cache_type: str = "general") -> None:
        """Record a cache hit"""
        self.processing.cache_hits += 1

    def record_cache_miss(self, cache_type: str = "general") -> None:
        """Record a cache miss"""
        self.processing.cache_misses += 1
    ...
    def finalize(self) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "operation_times": {
                op: {"start_time": times[0], "end_time": times[1], "duration_seconds": times[2]}
            ...
            "success_rate": (
                (
                    ...
                    / (self.processing.cards_processed + self.processing.cards_failed)
                )
                * 100
                if (self.processing.cards_processed + self.processing.cards_failed) > 0
                else 100.0
            ),
        }
    ...
    def get_summary(self) -> str:
        ...
        lines = [
            ...
            (
                ...
                if (self.processing.cache_hits + self.processing.cache_misses) > 0
                else "  • No cache data"
            ),
            "",
            "EXCEL GENERATION:",
